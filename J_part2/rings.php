...
<head>
    ...
    <title>AS Collection-Rings</title>
        ...
        <div class="container mt-3 py-4  ">
            ...
            <div class="row">
                <div class="col-md-6 col-6">
                    <h3 class="" style="color: #bbb572;">Rings</h3>
                </div>
                <div class="col-md-6 col-6">
                ...
                <div class="three-cards ">
                    <div class="row cols-1 row-cols-md-3 g-3">
                      <div class="col-md-4 col-lg-3 px-2 col-6 " data-aos="zoom-in">
                             <a href="product.php?src=<?php echo 'images/i11.jpg' ?>">
                      ...
                      <div class="col-md-4 col-lg-3 px-2 col-6 " data-aos="zoom-in">
                             <a href="product.php?src=<?php echo 'images/i73.jpg' ?>">
                                    
                                <div class="card">
                                    <img src="images/i73.jpg" class="card-img-top " id='img1' onmouseover="changeimg2(this)" onmouseout="previousimg2(this)" alt="..." class="img-fluid" height="300px">
                      ...
                      <div class="col-md-4 col-lg-3 px-2 col-6 " data-aos="zoom-in">
                             <a href="product.php?src=<?php echo 'images/i52.jpg' ?>">
