...
<head>
    ...
    <title>AS Collection-chains</title>
        ...
        <div class="container mt-3 py-4  ">
            ...
            <div class="row">
                <div class="col-md-6 col-6">
                    <h3 class="" style="color: #bbb572;">Chains</h3>
                </div>
                <div class="col-md-6 col-6">
                    ...
                    <div class="row cols-1 row-cols-md-3 g-3">
                      ...
                      <div class="col-md-4 col-lg-3 px-2 col-6 " data-aos="zoom-in">
                            <a href="product.php?src=<?php echo 'images/i13.jpg' ?>">
                                ...
                                <div class="card">
                                    <img src="images/i13.jpg" class="card-img-top " id='img1' onmouseover="changeimg2(this)" onmouseout="previousimg2(this)" alt="..." class="img-fluid" height="300px">
                      ...
                      <div class="col-md-4 col-lg-3 px-2 col-6 " data-aos="zoom-in">
                            <a href="product.php?src=<?php echo 'images/i20.jpg' ?>">
                                ...
                                <div class="card">
                                    <img src="images/i20.jpg" class="card-img-top " onmouseover="changeimg14(this)" onmouseout="previousimg14(this)" alt="..." class="img-fluid" height="300px">
                      ...
                      <div class="col-md-4 col-lg-3 px-2 col-6 " data-aos="zoom-in">
                            <a href="product.php?src=<?php echo 'images/i9.jpg' ?>">
                                ...
                                <div class="card">
                                    <img src="images/i9.jpg" class="card-img-top " onmouseover="changeimg41(this)" onmouseout="previousimg41(this)" alt="..." class="img-fluid" height="300px">
                      ...
                      <div class="col-md-4 col-lg-3 px-2 col-6 " data-aos="zoom-in">
                            <a href="product.php?src=<?php echo 'images/i16.jpg' ?>">
                                ...
                                <div class="card">
                                    <img src="images/i16.jpg" class="card-img-top " onmouseover="changeimg51(this)" onmouseout="previousimg51(this)" alt="..." class="img-fluid" height="300px">
                      ...
                      <div class="col-md-4 col-lg-3 px-2 col-6 " data-aos="zoom-in">
                            <a href="product.php?src=<?php echo 'images/i30.jpg' ?>">

                                <div class="card">
                                    <img src="images/i30.jpg" class="card-img-top " onmouseover="changeimg61(this)" onmouseout="previousimg61(this)" alt="..." class="img-fluid" height="300px">
